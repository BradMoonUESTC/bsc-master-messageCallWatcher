...
func opSelfBalance(pc *uint64, interpreter *EVMInterpreter, scope *ScopeContext,tx *types.Transaction,callpath string) ([]byte, error) {
...
func opChainID(pc *uint64, interpreter *EVMInterpreter, scope *ScopeContext,tx *types.Transaction,callpath string) ([]byte, error) {
