...
func applyTransaction(msg types.Message, config *params.ChainConfig, bc ChainContext, author *common.Address, gp *GasPool, statedb *state.StateDB, header *types.Header, tx *types.Transaction, usedGas *uint64, evm *vm.EVM) (*types.Receipt, error) {
	...
	//	fileName="./bsc_evm_data_transaction"+str_i+".csv"
	...
	//	msgTo=msg.To().String()
	//}
	//msgGas=strconv.FormatUint(msg.Gas(),10)
	//
	//msgNonce=strconv.FormatUint(msg.Nonce(),10)
	//
	//if msg.Data()!=nil{
	//	msgData=hex.EncodeToString(msg.Data())
	//}
	//
	...
	result, err := ApplyMessageMoreInfo(evm, msg, gp, tx)
	if err != nil {
		return nil, err
	}
